...
function CityTable() {
    ...
    return (
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg bg-customBlue mt-16">
            {isLoading && (
                <div className="absolute inset-0 flex justify-center items-center">
                    <Loader />
                </div>
            )}
            <table className={`w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
