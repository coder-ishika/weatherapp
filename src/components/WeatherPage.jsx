...
function WeatherPage() {
    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-customBlue">
            <div className="mb-4 relative">
                <input
                    ...
                    className="w-80 px-4 py-2 border border-blue-300 rounded-full focus:outline-none focus:ring focus:ring-blue-500 bg-gray-400"
                />
                <button onClick={handleGetInfo} className="absolute top-1/2 transform -translate-y-1/2 right-0 px-4 py-2 bg-gray-800 text-white rounded-full transition-transform">
                    Get Info
                </button>
            </div>
            <div className="bg-gray-400 shadow-lg rounded-lg p-6 transition-transform transform hover:scale-105">
                <div className="flex justify-between items-center mb-4 mx-auto">
                    ...
                    <button onClick={toggleForecast} className="px-8 py-4 bg-gray-800 text-white font-bold rounded-full transition-transform transform-gpu hover:-translate-y-1 hover:shadow-lg">
